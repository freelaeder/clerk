    ...
    >
      ...
      <div className={"flex h-full justify-between items-center px-4"}>
        ...
        <div className={"flex gap-8"}>
          ...
          {/*menu盒子*/}
          <div onClick={openMenu} className="burger-menu z-20 h-10 w-10 hover:cursor-pointer lg:flex lg:h-12 lg:w-[6.5rem]">
        ...
        {/*  隐藏的menu*/}
        <div className={`fixed z-20 bg-bgGreen ${menuVisibility} h-auto w-[95%] border-b-2 border-l-2 border-b-secGreen border-secGreen border-l-secGreen duration-[0.6s] xsm:w-[400px] md:w-[600px] lg:h-auto lg:min-h-[55%] lg:w-[auto] lg:min-w-[500px]`}>
        ...
        {/*  隐藏的背景*/}
        <div  onClick={closeMenu} className={`fixed bottom-0 right-0 ${menuBgOpacity}  z-[18] w-[100vw] backdrop-blur-sm duration-300 `}></div>
      </div>
    </div>
  );
};
